...
$mLoggedIn = MemoryRead(GetScannedAddress('ScanLoggedIn', -3)) -0x198 ;Updated 5.19.19
    ...
    ;SetValue('ChangeTargetFunction', '0x' & Hex(GetScannedAddress('ScanChangeTargetFunction', -0x78), 8)) ;Old
...
Func Scan()
    ...
    _('ScanTraderHook:')
    AddPattern('8955FC6A008D55F8B9BB') ;Updated 7.23.19
    _('ScanSleep:')
...
#cs ;Edited out because DervFeather Farm has more detailed function
